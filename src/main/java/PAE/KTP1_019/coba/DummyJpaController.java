 ...
 */
package PAE.KTP1_019.coba;

import PAE.KTP1_019.coba.exceptions.NonexistentEntityException;
import PAE.KTP1_019.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("PAE_KTP1_019_jar_0.0.1-SNAPSHOTPU");;
